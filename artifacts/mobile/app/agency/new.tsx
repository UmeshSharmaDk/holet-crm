  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>New Agency</Text>
      </View>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.iconHeader}>
            <View style={styles.iconWrap}>
              <Feather name="briefcase" size={32} color={C.primary} />
            </View>
            <Text style={styles.iconLabel}>Travel Agency</Text>
          </View>
          ...
          >
            {mutation.isPending
              ...
              : <><Feather name="plus" size={20} color="#fff" /><Text style={styles.submitText}>Create Agency</Text></>}
          </Pressable>
        </ScrollView>
      </KeyboardAvoidingView>
    </View>
